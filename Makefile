...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/yusiwen/go-build-helper/constant.Version=$(VERSION)" \
		-X "github.com/yusiwen/go-build-helper/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
